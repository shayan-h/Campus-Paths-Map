...
/**
 * <b>RatNum</b> represents an <b>immutable</b> rational number. It includes all the elements in
 ...
 */
// DEFINITION: "immutable" is a common term for which "Effective Java"
// (p. 63) provides the following definition: "An immutable class is
// simply a class whose instances cannot be modified.  All the
// information contained in each instance is provided when it is created
...
public final class RatNum extends Number implements Comparable<RatNum> {
     ...
     *
     * @return an integer approximation for this. The rational number is rounded to the nearest
     * integer.
     */
    @Override
    public int intValue() {
        // Round to the nearest integer by adding +/- .5 before truncating division.
     ...
     *
     * @return a float approximation for this.
     */
    @Override
    ...
    /**
     * Returns a long approximation for this. This method is specified by our superclass, Number.
     *
     * @return a long approximation for this. The value returned is rounded to the nearest long.
     */
    @Override
    ...
    // NOTE: In the implementation comments for the following methods, <this>
    //       is shorthand for "a/b" and <arg> for "x/y".
     ...
     *
     * @return a String representing this, in reduced terms. The returned string will either be
     * "NaN", or it will take on either of the forms "N" or "N/M", where N and M are both integers
     * in decimal notation and M != 0.
     */
    @Override
