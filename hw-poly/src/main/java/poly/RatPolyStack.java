...
public final class RatPolyStack implements Iterable<RatPoly> {
    ...
    public void swap() {
        // TODO: Fill in this method, then remove the RuntimeException
        checkRep();
        RatPoly pushFirst = polys.pop();
        RatPoly pushLast = polys.pop();
        polys.push(pushFirst);
        polys.push(pushLast);
        checkRep();
